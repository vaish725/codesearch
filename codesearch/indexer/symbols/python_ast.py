...
class PythonASTExtractor:
    ...
    def _walk_ast(self, node: ast.AST, symbols: List[Symbol], parent_class: Optional[str] = None):
        ...
        if isinstance(node, ast.ClassDef):
            ...
            for child in ast.iter_child_nodes(node):
                self._walk_ast(child, symbols, parent_class=parent_class)
    ...
    def _extract_function(self, node: ast.FunctionDef | ast.AsyncFunctionDef) -> Optional[Symbol]:
    ...
    def _extract_method(self, node: ast.FunctionDef | ast.AsyncFunctionDef, class_name: str) -> Optional[Symbol]:
