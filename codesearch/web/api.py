...
class SearchRequest(BaseModel):
    query: str = Field(..., description="Search query with filters (def:, class:, import:, lang:, path:)")
...
async def root():
    ...
    return HTMLResponse("<h1>CodeSearch API</h1><p>UI not found. Visit /docs for API documentation.</p>")
